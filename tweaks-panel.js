// Generated from tweaks-panel.jsx. Edit the .jsx source and regenerate if needed.
"use strict";
...
function useTweaks(defaults) {
  ...
  var setTweak = React.useCallback(function (keyOrEdits, val) {
    var _ref;
    var edits = typeof keyOrEdits === 'object' && keyOrEdits !== null ? keyOrEdits : (_ref = {}, _ref[keyOrEdits] = val, _ref);
    setValues(function (prev) {
      return _extends({}, prev, edits);
    });
...
function TweaksPanel(_ref2) {
  ...
  var _React$useState3 = React.useState(function () {
      ...
      return hasDeckStage && !!((_document$querySelect = document.querySelector('deck-stage')) != null && _document$querySelect._railEnabled);
    }),
    railEnabled = _React$useState3[0],
    setRailEnabled = _React$useState3[1];
  ...
  var _React$useState4 = React.useState(function () {
    ...
    railVisible = _React$useState4[0],
    setRailVisible = _React$useState4[1];
  ...
  React.useEffect(function () {
    var onMsg = function onMsg(e) {
      var _e$data;
      var t = e == null || (_e$data = e.data) == null ? void 0 : _e$data.type;
...
function TweakRadio(_ref7) {
  ...
  var _React$useState5 = React.useState(false),
    dragging = _React$useState5[0],
    setDragging = _React$useState5[1];
  ...
  var fitsAsSegments = maxLen <= ((_$3$options$length = {
    2: 16,
    3: 10
  }[options.length]) != null ? _$3$options$length : 0);
  if (!fitsAsSegments) {
    var resolve = function resolve(s) {
      var m = options.find(function (o) {
        return String(typeof o === 'object' ? o.value : o) === s;
      });
...
function TweakColor(_ref10) {
  ...
  return React.createElement(TweakRow, {
    ...
    var hero = colors[0],
      rest = _arrayLikeToArray(colors).slice(1);
