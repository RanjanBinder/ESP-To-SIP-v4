...
.dl-page-icon-badge {
  ...
  place-items: center;
  flex-shrink: 0;
  border: 1px solid rgba(55,55,200,.14);
}
.dl-page-heading {
  min-width: 0;
  display: grid;
